...
export const mjLesson1_1: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-first-prompt.jpg',
...
export const mjLesson1_2: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-interface.jpg',
...
export const mjLesson1_3: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-commands.jpg',
...
export const mjLesson1_4: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-masterpiece.jpg',
...
export const mjLesson2_1: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-parameters.jpg',
...
export const mjLesson2_2: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-style-ref.jpg',
...
export const mjLesson2_3: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-aspect-ratio.jpg',
...
export const mjLesson2_4: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-refine.jpg',
...
export const mjLesson3_1: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-multi-prompt.jpg',
...
export const mjLesson3_2: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-character.jpg',
...
export const mjLesson3_3: CoursivLesson = {
  ...
  blocks: [
    ...
    createPlaygroundBlock(
      ...
      '/images/course/midjourney/mj-commercial.jpg',
